...
public record TorrentGetResponse
{
    ...
    /// </summary>
    public IReadOnlyList<TorrentInfo> Torrents { get; init; } = null!;
...
public record PeerInfo
{
    ...
    /// </summary>
    public string FlagStr { get; init; } = null!;
    ...
    /// Peer's ID string.
    /// </summary>
    public string PeerId { get; init; } = null!;
...
public record Tracker
{
    ...
    /// </summary>
    public string Announce { get; init; } = null!;
    ...
    /// </summary>
    public string Scrape { get; init; } = null!;
...
public record TrackerStats
{
    ...
    /// </summary>
    public string LastAnnounceResult { get; init; } = null!;
    ...
    /// </summary>
    public string LastScrapeResult { get; init; } = null!;
